...
if ! [[ -d "${SCRIPT_DIR}/downloaded/WorldStrat" ]]; then
  mkdir "${SCRIPT_DIR}/downloaded/WorldStrat"
  wget https://zenodo.org/record/6810792/files/metadata.csv -P "${SCRIPT_DIR}/downloaded/WorldStrat"
